"use strict";
// ═══════════════════════════════════════════════════════
// HEADER BİLEŞENİ — Design System v12 (Unified Ottoman AAA)
...
function Header({ profile, notifCount, onNotif, page, onNavigate }) {
  ...
  return (
    <div style={{
      ...
      background:'linear-gradient(180deg, #1A0E00 0%, #170C00 100%)',
