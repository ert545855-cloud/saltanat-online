...
const NAV_GROUPS = [
  { id:'home', icon:'🏠', svgIcon:'home', label:'Ana Sayfa', rgb:'200,155,60', direct:true },
  {
    id:'ekonomi', icon:'💰', svgIcon:'money', label:'Ekonomi', rgb:'200,155,60',
    items:[
      { id:'jobs',            icon:'💼', svgIcon:'briefcase', label:'İşler',          rgb:'76,154,107'  },
      { id:'kariyer',         icon:'🏗️', svgIcon:'factory',   label:'Kariyer',        rgb:'200,155,60' },
      ...
      { id:'market',          icon:'🛒', svgIcon:'money',     label:'Market',         rgb:'200,155,60'  },
      { id:'holdings',        icon:'🏢', svgIcon:'briefcase', label:'Şirketler',      rgb:'200,155,60'  },
      { id:'economic_empire', icon:'👑', svgIcon:'chart',     label:'İmparatorluk',   rgb:'76,154,107'  },
      { id:'factory',         icon:'🏭', svgIcon:'factory',   label:'Atölye',        rgb:'200,155,60'  },
      { id:'mining',          icon:'⛏️', svgIcon:'mining',    label:'Maden',          rgb:'136,147,161' },
      { id:'education',       icon:'🎓', svgIcon:'education', label:'Eğitim',         rgb:'200,155,60'  },
      { id:'lonca_sistemi',   icon:'🤝', svgIcon:'users',     label:'Loncalar',       rgb:'76,154,107'  },
      { id:'daily',           icon:'📅', svgIcon:'tasks',     label:'Görevler',       rgb:'200,155,60'  },
      ...
      { id:'auction',         icon:'🏺', svgIcon:'money',     label:'Artırma Evi',    rgb:'200,155,60'  },
      { id:'kervan',          icon:'🐪', svgIcon:'truck',     label:'Kervanlar',      rgb:'200,155,60'  },
      { id:'kervan_koruma',   icon:'🛡️', svgIcon:'shield',    label:'Kervan Koruma',  rgb:'200,155,60'  },
      { id:'lonca_anlasma',   icon:'📜', svgIcon:'briefcase', label:'Lonca Anlaşması',rgb:'200,155,60'  },
  ...
  {
    id:'devlet', icon:'🏛️', svgIcon:'government', label:'Devlet', rgb:'200,155,60',
    items:[
      { id:'politics',        icon:'⚜️', svgIcon:'government', label:'Beylikler',  rgb:'200,155,60' },
      { id:'yetkilerim',      icon:'⭐', svgIcon:'crown',       label:'Yetkilerim', rgb:'200,155,60' },
      ...
      { id:'taxgov',          icon:'🏦', svgIcon:'bank',        label:'Hazine',     rgb:'200,155,60' },
      { id:'citybuild',       icon:'🏗️', svgIcon:'factory',     label:'İnşaat',     rgb:'200,155,60' },
      { id:'map',             icon:'🗺️', svgIcon:'map',         label:'Harita',     rgb:'76,154,107' },
      { id:'alliance',        icon:'🤝', svgIcon:'users',       label:'İttifak',    rgb:'200,155,60' },
      ...
      { id:'lonca_turnuva',   icon:'🏆', svgIcon:'trophy',      label:'Turnuva',      rgb:'200,155,60' },
      { id:'world',           icon:'🌍', svgIcon:'map',         label:'Dünya',      rgb:'200,155,60' },
      { id:'npcplayers',      icon:'🤖', svgIcon:'user',        label:'NPC',        rgb:'136,147,161'},
      { id:'eyalet_harita',   icon:'🗺️', svgIcon:'map',         label:'Eyaletler',  rgb:'200,155,60' },
      { id:'valilik',         icon:'👑', svgIcon:'crown',       label:'Valilik Yönetim', rgb:'200,155,60' },
      { id:'saray',           icon:'🏰', svgIcon:'government',  label:'Saray',      rgb:'200,155,60' },
      { id:'adalet',          icon:'⚖️', svgIcon:'law',         label:'Adalet',     rgb:'194,75,67'  },
      { id:'lonca',           icon:'⚒️', svgIcon:'briefcase',   label:'Loncalar',   rgb:'200,155,60' },
      { id:'tenders',         icon:'🏗️', svgIcon:'briefcase',   label:'İhaleler',   rgb:'200,155,60' },
      { id:'wiki',            icon:'📚', svgIcon:'education',   label:'Wiki',       rgb:'200,155,60' },
      { id:'party_center',    icon:'⚜️', svgIcon:'scroll',      label:'Parti',       rgb:'200,155,60' },
    ],
  },
  {
    id:'sosyal', icon:'👥', svgIcon:'users', label:'Sosyal', rgb:'136,147,161',
    items:[
      { id:'envanter',     icon:'📦', svgIcon:'briefcase', label:'Envanter',     rgb:'200,155,60'  },
      { id:'chat',         icon:'💬', svgIcon:'chat',      label:'Sohbet',       rgb:'136,147,161' },
      { id:'klanchat',     icon:'🔒', svgIcon:'shield',    label:'Klan',         rgb:'136,147,161' },
      { id:'dm',           icon:'📬', svgIcon:'chat',      label:'Mesaj',        rgb:'200,155,60'  },
      { id:'players',      icon:'👥', svgIcon:'users',     label:'Oyuncular',    rgb:'200,155,60'  },
      { id:'social',       icon:'📱', svgIcon:'users',     label:'Sosyal',       rgb:'136,147,161' },
      { id:'newspaper',    icon:'📰', svgIcon:'newspaper', label:'Gazete',       rgb:'200,155,60'  },
      { id:'football',     icon:'⚽', svgIcon:'trophy',    label:'Futbol',       rgb:'76,154,107'  },
      { id:'duyuru_panosu',icon:'📣', svgIcon:'chat',      label:'İlan Panosu',  rgb:'200,155,60'  },
      { id:'saray_intrigi',icon:'🎴', svgIcon:'crown',     label:'Saray İntrigi',rgb:'200,155,60'  },
      { id:'casino',       icon:'🎰', svgIcon:'crown',     label:'Kumarhane',    rgb:'200,155,60'  },
      { id:'duyurular',    icon:'📣', svgIcon:'newspaper', label:'Duyurular',    rgb:'200,155,60'  },
      { id:'leaderboard',  icon:'🏆', svgIcon:'medal-tiers', label:'Sıralama',   rgb:'200,155,60'  },
      { id:'achievements', icon:'🎖️', svgIcon:'crown',    label:'Başarılar',    rgb:'200,155,60'  },
      { id:'sezon',        icon:'🏅', svgIcon:'trophy',    label:'Sezon',        rgb:'200,155,60'  },
      ...
      { id:'mektup',       icon:'📜', svgIcon:'chat',      label:'Mektuplar',    rgb:'200,155,60'  },
      { id:'itibar',       icon:'⭐', svgIcon:'crown',     label:'İtibar',       rgb:'200,155,60'  },
      { id:'fal_carki',       icon:'🎡', svgIcon:'trophy',    label:'Fal Çarkı',       rgb:'167,139,250' },
      { id:'gunluk_gorev',    icon:'📋', svgIcon:'tasks',     label:'Günlük Görev',    rgb:'200,155,60'  },
      { id:'hizli_merkez',    icon:'⚡', svgIcon:'money',     label:'Hızlı Merkez',    rgb:'200,155,60'  },
      { id:'rozet_koleksiyon',icon:'🏅', svgIcon:'trophy',    label:'Rozetler',         rgb:'200,155,60'  },
      { id:'unvan_sistemi',   icon:'🎖️', svgIcon:'crown',    label:'Unvanlar',         rgb:'200,155,60'  },
      ...
      { id:'bildirim_gecmisi',icon:'🔔', svgIcon:'chat',      label:'Bildirimler',      rgb:'200,155,60'  },
      { id:'profil_kart',     icon:'📸', svgIcon:'user',      label:'Profil Kartı',     rgb:'200,155,60'  },
      { id:'macera_gunlugu',  icon:'📖', svgIcon:'education', label:'Macera Günlüğü',   rgb:'200,155,60'  },
      { id:'osmanli_gunu',    icon:'🕌', svgIcon:'education', label:'Osmanlı Günü',     rgb:'200,155,60'  },
    ],
  },
  {
    ...
    items:[
      ...
      { id:'etkinlik_takvimi',icon:'📅', svgIcon:'tasks',     label:'Etkinlik Takvimi',rgb:'200,155,60'  },
      { id:'ferman',          icon:'📜', svgIcon:'law',       label:'Ferman Divanı',   rgb:'200,155,60'  },
...
NAV_GROUPS.find(g => g.id === 'devlet')?.items?.push(
  { id:'ruzname',    icon:'📆', svgIcon:'tasks',  label:'Ruzname',       rgb:'200,155,60' },
  { id:'padisahlik', icon:'👑', svgIcon:'throne', label:'Padişahlık',    rgb:'200,155,60' }
);
...
// v12 — artık window.DS (src/theme.js) ile aynı paleti kullanıyor.
const BN_DS = {
  bg:      'rgba(26, 14, 0, 0.94)',
  surface: (window.DS && window.DS.surface) || '#2D1800',
  border:  (window.DS && window.DS.goldBorder) || 'rgba(200,155,60,0.28)',
  gold:    (window.DS && window.DS.gold) || '#C89B3C',
  muted:   (window.DS && window.DS.muted) || '#A9A6A0',
  text:    (window.DS && window.DS.text) || '#F5EBD7',
  navH:    68,
  radius:  22,
};
    ...
    openGroup && currentGroup && React.createElement(React.Fragment, null,
      ...
      React.createElement('div', {
        style: {
          ...
          boxShadow:'0 -12px 48px rgba(0,0,0,0.75), 0 0 0 1px rgba(200,155,60,0.06)',
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        style:{
          ...
          boxShadow:'0 -6px 36px rgba(0,0,0,0.6), 0 -1px 0 rgba(200,155,60,0.1), inset 0 1px 0 rgba(255,255,255,0.05)',
        ...
        allGroups.map(group => {
          ...
          const groupRgb  = group.rgb || '200,155,60';
