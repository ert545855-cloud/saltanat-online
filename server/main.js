...
// src/app.js ve DevletScreen.js envanter ikonlarını '/icons/64/...' yolundan
// çekiyor ama fiziksel dosyalar 'public/icons/64/...' altında — eksik route
// yüzünden tüm eşya/silah/iksir ikonları 404 veriyordu. Düzeltme:
app.use('/icons',   express.static(path.join(root, 'public', 'icons'), staticOpts));
