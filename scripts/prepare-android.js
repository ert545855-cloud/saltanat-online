...
// index.html already reads window._SOCKET_URL when it builds its io() connection
// (see 'var socketUrl = window._SOCKET_URL || ...'), so we just need to set that.
window._SOCKET_URL = '${PRODUCTION_URL}';
window._SALTANAT_ONLINE_IS_NATIVE = true;
</script>`;
...
const ROOT_FILES = ['manifest.json', 'service-worker.js', 'favicon.ico', 'favicon.png', 'saltanat-icon.png'];
